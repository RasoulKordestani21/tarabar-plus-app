...
const AccountScreen = () => {
  return (
    <View style={tw`flex-1 bg-text`}>
      {/* User Card */}
      <View
        style={tw`bg-green-500 p-4 m-4 rounded-lg shadow-lg justify-center items-center`}
      >
        ...
        <View style={tw`mt-4`}>
          ...
          <View style={tw`flex flex-row-reverse justify-between w-full `}>
            ...
            <Text style={tw`text-white text-base font-vazir`}>09381128881</Text>
          </View>
          ...
          <View style={tw`flex flex-row-reverse justify-between w-full `}>
            ...
            <Text style={tw`text-white text-base font-vazir`}>راننده</Text>
          </View>
        </View>
      </View>
